...
func RegisterHandlers(ctx context.Context, prefix string, router server.HTTPRouter, filer filer.AWS) {
...
func registerBucketHandlers(ctx context.Context, prefix string, router server.HTTPRouter, filer filer.AWS) {
