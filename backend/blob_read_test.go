...
func TestReadObject_Mem(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			reader, obj, err := backend.ReadObject(ctx, schema.ReadObjectRequest{URL: tt.url})
...
func TestReadObject_S3(t *testing.T) {
	...
	t.Run("read non-existent object", func(t *testing.T) {
		...
		_, _, err := backend.ReadObject(ctx, schema.ReadObjectRequest{URL: nonExistentURL})
...
func TestReadObject_PartialRead(t *testing.T) {
	...
	t.Run("partial read and close", func(t *testing.T) {
		...
		reader, obj, err := backend.ReadObject(ctx, schema.ReadObjectRequest{URL: "mem://testbucket/large.txt"})
		require.NoError(err)
...
func TestReadObject_EmptyFile(t *testing.T) {
	...
	t.Run("read empty file", func(t *testing.T) {
		...
		reader, obj, err := backend.ReadObject(ctx, schema.ReadObjectRequest{URL: "mem://testbucket/empty.txt"})
		require.NoError(err)
		defer reader.Close()
...
func TestReadObject_BinaryContent(t *testing.T) {
	...
	t.Run("read binary file", func(t *testing.T) {
		...
		reader, obj, err := backend.ReadObject(ctx, schema.ReadObjectRequest{URL: "mem://testbucket/binary.bin"})
		require.NoError(err)
		defer reader.Close()
